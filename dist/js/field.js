...
Nova.booting(function (Vue, router) {
    Vue.component("chrome-picker", __WEBPACK_IMPORTED_MODULE_0_vue_color__["Chrome"]);
    Vue.component("compact-picker", __WEBPACK_IMPORTED_MODULE_0_vue_color__["Compact"]);
    Vue.component("grayscale-picker", __WEBPACK_IMPORTED_MODULE_0_vue_color__["Grayscale"]);
    Vue.component("material-picker", __WEBPACK_IMPORTED_MODULE_0_vue_color__["Material"]);
    Vue.component("photoshop-picker", __WEBPACK_IMPORTED_MODULE_0_vue_color__["Photoshop"]);
    Vue.component("sketch-picker", __WEBPACK_IMPORTED_MODULE_0_vue_color__["Sketch"]);
    Vue.component("slider-picker", __WEBPACK_IMPORTED_MODULE_0_vue_color__["Slider"]);
    Vue.component("swatches-picker", __WEBPACK_IMPORTED_MODULE_0_vue_color__["Swatches"]);
    Vue.component("twitter-picker", __WEBPACK_IMPORTED_MODULE_0_vue_color__["Twitter"]);
    Vue.component("index-color", __webpack_require__(5));
    Vue.component("detail-color", __webpack_require__(8));
    Vue.component("form-color", __webpack_require__(11));
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "inline-flex items-center" }, [
    _c("div", {
      ...
      style: { backgroundColor: _vm.field.value, width: "20px", height: "20px" }
    }),
    _vm._v(" "),
    _c("div", [_vm._v(_vm._s(_vm.field.value))])
  ])
}
var staticRenderFns = []
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
         ...
         */
        disableAlpha: function disableAlpha() {
  ...
  return _c(
    ...
    [
      _c(
        ...
        { slot: "field" },
        [
          _c("div", { staticClass: "inline-flex mb-2" }, [
            _c("div", {
              staticClass:
                "color-input rounded-l-lg border-r-0 h-100 border border-60 color-input-value",
              style: { backgroundColor: _vm.value, width: "36px" }
            }),
            _vm._v(" "),
            _c("input", {
              directives: [
              ...
              staticClass:
                "w-25 form-control form-input form-input-bordered color-input rounded-l-none",
